        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryPreferences = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EvaluationPreferences = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AllowNsfw = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseChat", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Evaluations = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserBaseChat", x => new { x.ChatsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_AppUserBaseChat_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserBaseChat_BaseChat_ChatsId",
                        column: x => x.ChatsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseChatId = table.Column<int>(type: "int", nullable: true),
                    Discriminator = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BaseMessage_AspNetUsers_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaseMessage_BaseChat_BaseChatId",
                        column: x => x.BaseChatId,
                        principalTable: "BaseChat",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseMessage_BaseMessage_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseMessage_BaseChatId",
                table: "BaseMessage",
                column: "BaseChatId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseMessage_ParentId",
                table: "BaseMessage",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseMessage_SenderUserId",
                table: "BaseMessage",
                column: "SenderUserId");
